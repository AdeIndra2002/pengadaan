...
<body class="A4 potrait">
    <section class="sheet">
        ...
        <h1 style="text-align: center;">LAPORAN PENERIMAAN</h1>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php $no = 1; ?>
                <?php foreach ($view_penerimaan as $penerimaan) : ?>
                <tr>
                    <td class="text-center align-middle">{{ $no }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->tanggalPenerimaan }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->jumlahPenerimaan }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->pengajuan->namaPengajuan }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->divisi->divisi }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->pengajuan->tanggalPengajuan }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->barang->barang }}</td>
                    <td class="text-center align-middle">{{ $penerimaan->kategori->kategori }}</td>
                </tr>
                <?php $no++;
                endforeach; ?>
            </tbody>
